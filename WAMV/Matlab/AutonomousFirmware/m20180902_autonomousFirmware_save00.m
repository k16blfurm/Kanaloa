...
% Check Rostopics to make sure sensors from simulation
% are being subscribed by the MAtlab code
function m20180902_autonomousFirmware_save00()
...
%        error.xDist2goal))));
    ...
    thrustCommands.Q1 = round(thrustCommands.Q1*(2/110),0);
    thrustCommands.Q2 = round(thrustCommands.Q2*(2/110),0);
...
function displayStuff(goal,pose,thrustCommands,error)
    ...
    % Print Raw Position and Orientation data
    fprintf('Lattitude Longitude Altitude: %3.2f %3.2f %3.2f\n', wamvGpsLat, wamvGpsLon, wamvGpsAlt);
    fprintf('Quaternion IMU Angles X,Y,Z,Q: %3.2f %3.2f %3.2f %3.2f\n',imuQx,imuQy,imuQz,imuQw);
    fprintf('Euler Angle X,Y,Z [Rad]: %3.2f %3.2f %3.2f\n', imutx,imuty,imutz);
