...
function m20180825_autonomousFirmware()
...
function pub = createRosPublishers()
    ...
    pub.autoQ1 = rospublisher('/right_front_thrust_cmd','std_msgs/Float32');
    pub.autoQ2 = rospublisher('/left_front_thrust_cmd','std_msgs/Float32');
