...
% Change Right and Left Thruster publishers from pub.autoQ1 and pub.autoQ2
% to pub.autoQ4 and pub.autoQ3
function m20180902_autonomousFirmware_save04()
...
function pub = createRosPublishers()
    ...
    pub.autoQ3 = rospublisher('/left_thrust_cmd','std_msgs/Float32');
    pub.autoQ4 = rospublisher('/right_thrust_cmd','std_msgs/Float32');
...
function displayStuff(goal,pose,thrustCommands,error)
    ...
    fprintf('Thrusters [-1 to 1]:  %3.2f, %3.2f,\n\n',...
        thrustCommands.Q3,thrustCommands.Q4);%thrustCommands.Q1,thrustCommands.Q2,);
